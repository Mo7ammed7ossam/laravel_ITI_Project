...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card-text  p-3">
                    ...
                    <div>
                        <span class="fs-3">Title : </span> <span class="fs-5">
                            {{ $selectedPost['title'] }}
                        </span>
                    </div>
        ...
        <div class="card mt-3">
            <div class="card-body ">
                <h5 class="card-title bg-dark text-light p-3 ">Creator information</h5>
                <div class="card-text  p-3">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <span class="fs-3">Created At : </span> <span class="fs-5">
                                {{ $selectedPost['created_at']->isoFormat('dddd Do of MMMM OY LTS') }} </span>
                        </li>
                    </ul>
